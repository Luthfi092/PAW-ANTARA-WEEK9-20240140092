  ...
  try {
    ...
    if (existingTodos === 0) {
      await Todo.bulkCreate([
        { title: "Belajar Sequelize", is_done: true, user_id: user1.id, category_id: catKuliah.id },
        { title: "Bikin API Todo", is_done: true, user_id: user1.id, category_id: catKuliah.id },
        { title: "Nambahin fitur seeder", is_done: false, user_id: user1.id, category_id: catKerja.id },
